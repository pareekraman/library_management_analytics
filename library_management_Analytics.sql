...
-- Tables Used
-- Books →   Book-wise information including title, author, category, ISBN, rental price, and availability status.
-- Issued Status →   Book issue transaction data including member, employee, issued book, issue date, and related issue details.
-- Return Status →   Book return transaction data including member, issued book, return date, and return status.
-- Members →   Library member information including member ID, name, registration date, and contact details.
-- Employees →   Library employee information including employee ID, name, position, salary, and branch details.
-- Branch →   Library branch information including branch ID, manager, branch address, and contact information.
...
-- =================================================================================================================================
--     END OF LIBRARY MANAGEMENT ANALYTICS — SQL PROJECT
-- ================================================================================================================================= 